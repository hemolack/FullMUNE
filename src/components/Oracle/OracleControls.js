    ...
    return(
        <div className={classes.OracleControls}>
            ...
            <div className="input-group flex-nowrap">
                ...
                <Button variant="secondary" disabled={props.question === ''} onClick={() => { props.ask(props.question, oracleService.YES_OR_NO); props.setQuestion(''); }}>Y/N</Button>
                <Button variant="secondary" disabled={props.question === ''} onClick={() => { props.ask(props.question, oracleService.LIKELY_NO); props.setQuestion(''); }}>Likely</Button>
                <Button variant="secondary" disabled={props.question === ''} onClick={() => { props.ask(props.question, oracleService.LIKELY_YES); props.setQuestion(''); }}>Unlikely</Button>
